...
#ifndef FACE_DM_RTI_ShapeType_TSS_TypedTSImpl434673847_hpp
#define FACE_DM_RTI_ShapeType_TSS_TypedTSImpl434673847_hpp
...
namespace RTI {
    namespace ShapeType {
        class Read_Callback : public FACE::TSS::RTI::ShapeType::Read_Callback
        {
          public:
            Read_Callback();
        ...
        class TypedTS : public FACE::TSS::RTI::ShapeType::TypedTS 
        {
          public:
            TypedTS();
...
namespace FACE {
    ...
    Sequence<FACE::DM::RTI::ShapeType >;
...
#endif /* FACE_DM_RTI_ShapeType_TSS_TypedTSImpl434673847__hpp */
